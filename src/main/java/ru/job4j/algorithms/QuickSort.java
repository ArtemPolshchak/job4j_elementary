...
public class QuickSort {
     ...
     * @param arr массив
     * @param from граница подМассива с которого начинается сортировка
     * @param to граница подМассива до которого продолжается сортировка
     */
    ...
    /**
     *метод выбирает опорный елемент
     * затем делит данный массив на две части ( опорный елемент является серединой)
     * те элементы, которые меньше опорного элемента перебрасываются в левую часть массива
     * те элементы, которые больше опорного эл. перебрасываются в правую часть.
     * @param arr массив
     * @param from граница подМассива с которого начинается сортировка
     * @param to граница подМассива до которого продолжается сортировка
     * @return индекс середины разделенного на две части массива
     */
    ...
    /**
     * Метод по индексам меняет местами элементы массива
     * @param array массив
     * @param index1 интекс массива, который станет на место <index2>
     * @param index2 интекс массива, который станет на место <index1>
     */
    ...
    /**
     * Метод выводит на екран процесс сортировки массива
     */
